...
namespace eIMIC223925.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<int> Delete(int productId)
        {
            ...
            if (product == null) throw new eIMIC223925Exception($"Cannot find a product: {productId}");
        ...
        public async Task<int> RemoveImage(int imageId)
        {
            ...
            if (productImage == null)
                throw new eIMIC223925Exception($"Can't find an image with Id {imageId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new eIMIC223925Exception($"Cannot find a product with id: {request.Id}");
        ...
        public async Task<int> UpdateImage(int imageId, ProductImageUpdateRequest request)
        {
            var productImage = await _context.ProductImages.FindAsync(imageId);
            if (productImage == null)
                throw new eIMIC223925Exception($"Cannot find an image with id {imageId}");
