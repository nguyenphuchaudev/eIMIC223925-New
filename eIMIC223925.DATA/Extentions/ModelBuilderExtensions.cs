...
namespace eIMIC223925.DATA.Extentions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
               new AppConfig() { Key = "HomeTitle", Value = "This is home page of eIMIC223925" },
               new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of eIMIC223925" },
               new AppConfig() { Key = "HomeDescription", Value = "This is description of eIMIC223925" }
               );
            ...
            var roleId = new Guid("139B9D0B-967B-454A-B471-B2BB5F6C7522");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "nguyenphuchau.bvbnd@gmail.com",
                NormalizedEmail = "nguyenphuchau.bvbnd@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "Abcd1234$"),
                SecurityStamp = string.Empty,
                FirstName = "Phuc Hau",
                LastName = "Nguyen",
                Dob = new DateTime(1980, 05, 26)
            });
